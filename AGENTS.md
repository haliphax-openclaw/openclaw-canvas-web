...
- `openclaw://agent?message=...` or `openclaw://<hostname>/agent?message=...` — triggers agent runs via deep link. The container hostname form is supported for Docker network URLs.
